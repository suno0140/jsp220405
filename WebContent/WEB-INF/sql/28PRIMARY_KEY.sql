...
-- pirmary key : not null, unique 조합
...
INSERT INTO mytable13 (col1, col2) VALUES('a', 'b'); -- 중복 안됨 (primary key)
INSERT INTO mytable13 (col1, col2) VALUES('a', null); -- null 도 안됨 (primary key)
...
DELETE FROM mytable18 WHERE col1 = 3; -- col1 3이 지워짐 그뒤에 번호는 그대로 있음